...
for ds_cnt, ds in enumerate(datasets):
    ...
    for name, clf in zip(names, classifiers):
        ...
        ##ax.scatter(X_test[:, 0], X_test[:, 1], c=y_test, cmap=cm_bright, edgecolors='k', alpha=0.5, s=40)

        ax.scatter(X_train[:, 0], X_train[:, 1], c=y_train, edgecolors='k', s=40)
        ax.scatter(X_test[:, 0], X_test[:, 1], c=y_test, edgecolors='k', alpha=0.5, s=40)
